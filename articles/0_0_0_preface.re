...
本書では、Unityをある程度触ったことがある中級者の方、Webの基礎的知識であるサーバー・クライアントの概念について理解している読者を想定しており、
UGSの基本的な使い方と『PlayersLink』の仕組みを解説していくことでUGSへの理解を深め、読者が最短経路でオンラインゲームを開発できるようになることを目指します。
